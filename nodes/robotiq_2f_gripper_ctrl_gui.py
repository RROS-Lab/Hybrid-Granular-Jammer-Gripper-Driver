...
class RobotiqCGripper(object):
    def __init__(self):
        ...
        self.command_sub = rospy.Subscriber('gripper_controller/gripper_action/goal', FollowJointTrajectoryActionGoal, self.callback)
        print('hit')
    ...
    def callback(self, msg):
        ...
        position_msg = list(msg.goal.trajectory.points[len(ref_msg)-1].positions)
...
def main():
    ...
    if is_reset:
        ...
        gripper.reset()
        activate_stat    = gripper.activate()
    ...
    while not rospy.is_shutdown():
        ...
        rospy.logdebug('robotiq_2f_gripper_ctrl_gui| current gripper pos: {}'.format(cur_pos))
